...
@endsection
    ...
    <div class="banner-image " >
        <div class="px-1 col-lg-6 py-lg-5 offset-lg-3">
            ...
            <div class="gradient-text text-uppercase price-head ">OOPs! You don’t have a Investment plan </div>
                    ...
                    <div class="py-4 pl-2 shadow-sm pricing-card pl-lg-3 card">
                        <div class="card-body position-relative">
                         ...
                         @foreach ($v->benefits as  $value)
                            ...
                            <a href="{{ route('inv.pricing',['id'=>$v->id,'name'=>$v->name]) }}" class="blue-btn">
                                Proceed to Payment
                            </a>
